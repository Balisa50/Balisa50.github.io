...
export const CASE_STUDIES: Record<string, CaseStudy> = {
  ...
  "nova": {
    ...
    constraints: [
      ...
      "I could not train on a generic set like German Credit or a Kaggle loan dump. They do not reflect West African dynamics, group lending, sector-specific default, the informal economy, so a model trained on them would learn the wrong structure and I would not be able to defend it.",
    ...
    outcome: [
      ...
      "All four validation metrics pass: statistical similarity 0.94, correlation L1 0.05, TSTR 0.92 (AUC ratio 0.94), and distance-to-closest-record privacy 1.10 with 1.1 percent near-duplicates",
  ...
  "gambia-population-projection": {
    ...
    research: [
      ...
      "Read Raftery et al. (2012, PNAS), the Bayesian hierarchical method the UN actually adopted for WPP in 2015. I needed to understand it before benchmarking against WPP rather than just citing it.",
  ...
  "ayat": {
    ...
    research: [
      ...
      "Read about the Meccan vs Medinan classification. Surahs were revealed in two distinct phases (Meccan: 13 years, cosmic, urgent, short; Medinan: 10 years, legislative, communal, long). Realised this was free metadata I could use for color, a layer of meaning that a religious reader would already recognize.",
    ],
    constraints: [
