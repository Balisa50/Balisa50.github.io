/**
 * Body of the bespoke "The Gambia: 65 Years in Numbers" case study.
 *
 * Shared by the in-portfolio page (/projects/gambia, standalone=false → top nav
 * shown) and the clean shareable page (/case-studies/gambia, standalone=true →
 * no nav, minimal credit footer instead). Every figure is rendered from the
 * static export under public/projects/gambia/.
 */

import Link from "next/link";
import Image from "next/image";
import { StandaloneCredit } from "@/components/CaseStudyView";
  ...
  return (
    <figure className="my-10">
      <div className="overflow-hidden rounded-xl border border-white/10 bg-white">
        <Image src={src} alt={alt} width={1400} height={780} className="w-full h-auto" unoptimized />
      </div>
...
export function GambiaCaseStudyBody({ standalone }: { standalone: boolean }) {
  return (
